...
public partial class WfrmPermiso : System.Web.UI.Page
{
    ...
    protected void btnAgregar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string comando = "insert into Permiso values('" + Nombre + "');";
            ...
            {
                lblMensaje.Text = "Permiso Registrado";
                cn.Close();
                txtid.Text = "";
                txtNombre.Text = "";
    ...
    protected void btnEliminar_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand();
        cmd.Connection = cn;
        cmd.CommandText = "delete from Permiso where id=" + id + ";";
        cmd.CommandType = CommandType.Text; cn.Open();
        try
        {
            if (cmd.ExecuteNonQuery() > 0)
    ...
    protected void btnModificar_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "update Permiso set Nombre='" + Nombre + "'  where id=" + id;
    ...
    protected void btnConsultar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("select * from Permiso", cn);
            cmd.CommandType = CommandType.Text;
            cn.Open();
